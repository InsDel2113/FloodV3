...
namespace Sandbox
{
	public class WaterController
	{
		...
		public virtual void OnEnterWater( ModelEntity other )
		{
			...
			if ( Flood.FloodGame.Instance.WaterSystem != null)
			 Flood.FloodGame.Instance.WaterSystem.WaterListUpdate( other, true );
		}
		...
		public virtual void OnLeaveWater( ModelEntity other )
		{
			...
			if ( Flood.FloodGame.Instance.WaterSystem != null )
				Flood.FloodGame.Instance.WaterSystem.WaterListUpdate( other, false );
		}
